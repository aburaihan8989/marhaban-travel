...
@section('title', 'Travel Expense Categories')
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">Travel Expense Categories</li>
    </ol>
@endsection
    ...
    <div class="modal fade" id="categoryCreateModal" tabindex="-1" role="dialog" aria-labelledby="categoryCreateModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('travel-expense-categories.store') }}" method="POST">
                    @csrf
