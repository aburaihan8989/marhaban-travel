...
class HajjExpensesDataTable extends DataTable
{
    ...
    public function dataTable($query) {
        return datatables()
            ...
            ->addColumn('package_code', function($data){
                return HajjPackage::findOrFail($data->package_id)->package_code;
            })
    ...
    public function query(HajjExpense $model) {
    ...
    public function html() {
        return $this->builder()
            ->setTableId('hajj-expenses-table')
    ...
    protected function filename(): string {
        return 'HajjExpenses_' . date('YmdHis');
    }
}
