            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="hajj-saving-form" action="{{ route('hajj-savings.store') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-lg-4">
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="register_date" required value="{{ now()->format('Y-m-d') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    Create Hajj Savings <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
...
@push('page_scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#hajj-saving-form').submit(function () {
