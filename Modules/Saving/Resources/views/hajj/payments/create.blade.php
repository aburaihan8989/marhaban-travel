...
@section('title', 'Create Hajj Payment')
...
@section('content')
    <div class="container-fluid">
        <form id="hajj-payment-form" action="{{ route('hajj-saving-payments.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-12">
...
@push('page_scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            //     $('#amount').maskMoney('mask', {{ $hajj_saving->last_amount }});
            // });
