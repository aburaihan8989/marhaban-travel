...
<head>
    ...
    @if ( $hajj_saving_payment->trx_type == 'Saving')
        <title>Details Hajj Savings Payment Receipt</title>
    @else
        <title>Details Hajj Savings Refund Receipt</title>
    @endif
        ...
        <div class="col-xs-12">
            <div style="text-align: center;margin-bottom: 25px;">
                ...
                <h4 style="margin-bottom: 20px; font-size:17px;">
                    <span>ID Transaction :</span> <strong>{{ $hajj_saving_payment->reference }}</strong></br></br>
                    @if ( $hajj_saving_payment->trx_type == 'Saving')
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="align-middle" style="font-size: 15px; font-weight: bold;">
                                                    {{ $hajj_saving_payment->payment_reference }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
