...
@if ($hajjsavingPayment->trx_type == 'Saving')
    @section('title', 'Edit Hajj Savings Payment')
    ...
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">Edit Hajj Savings Payment</li>
    </ol>
    @endsection

    @section('content')
        <div class="container-fluid">
            <form id="payment-form" action="{{ route('hajj-saving-payments.update', $hajjsavingPayment) }}" method="POST">
                @csrf
                @method('patch')
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="reference" required readonly value="{{ $hajjsavingPayment->reference }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="date">Savings Date <span class="text-danger">*</span></label>
                                            <input type="date" class="form-control" name="date" required value="{{ $hajjsavingPayment->getAttributes()['date'] }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input id="amount" type="text" class="form-control" name="amount" required value="{{ old('amount') ?? $hajjsavingPayment->amount }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="from-group">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="payment_method" id="payment_method" required>
                                                    <option {{ $hajjsavingPayment->payment_method == 'Cash' ? 'selected' : '' }} value="Cash">Cash</option>
                                                    <option {{ $hajjsavingPayment->payment_method == 'Transfer' ? 'selected' : '' }} value="Transfer">Transfer</option>
                                                    <option {{ $hajjsavingPayment->payment_method == 'QRIS' ? 'selected' : '' }} value="QRIS">QRIS</option>
                                                    <option {{ $hajjsavingPayment->payment_method == 'Other' ? 'selected' : '' }} value="Other">Other</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" id="status" required>
                                                ...
                                                <option {{ $hajjsavingPayment->status == 'Approval' ? 'selected' : '' }} value="Approval">Approval</option>
                                                <option {{ $hajjsavingPayment->status == 'Verified' ? 'selected' : '' }} value="Verified">Verified</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input id="payment_reference" type="text" class="form-control" name="payment_reference" value="{{ $hajjsavingPayment->payment_reference }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" name="note">{{ old('note') ?? $hajjsavingPayment->note }}</textarea>
                                </div>
    ...
    @endpush
@else
    @section('title', 'Edit Hajj Savings Refund')
    ...
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">Edit Hajj Savings Refund</li>
    </ol>
    @endsection
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input id="refund_amount" type="text" class="form-control" name="refund_amount" required value="{{ old('refund_amount') ?? $hajjsavingPayment->refund_amount }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
