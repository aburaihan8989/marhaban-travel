...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">Edit Hajj Savings</li>
    </ol>
@endsection
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="agent_id" id="agent_id" required>
                                                ...
                                                @foreach(\Modules\People\Entities\Agent::all() as $agent)
                                                    <option {{ $hajj_saving->agent_id == $agent->id ? 'selected' : '' }} value="{{ $agent->id }}">{{ $agent->agent_code . ' | ' . $agent->agent_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            @if ($hajj_saving->agent_id == '')
                                                <input type="text" class="form-control" name="agent_phone" value="" readonly>
                                            @else
                                                <input type="text" class="form-control" name="agent_phone" value="{{ $hajj_saving->umrohAgents->agent_phone }}" readonly>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="customer_bank" id="customer_bank" required>
                                            ...
                                            <option {{ $hajj_saving->customer_bank == 'Mandiri' ? 'selected' : '' }} value="Mandiri">Mandiri</option>
                                            <option {{ $hajj_saving->customer_bank == 'Other' ? 'selected' : '' }} value="Other">Other</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
