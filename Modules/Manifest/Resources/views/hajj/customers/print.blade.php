...
<head>
    ...
    <title>Details Customer Manifest Hajj</title>
        ...
        <div class="col-xs-12">
            <div style="text-align: center;margin-bottom: 25px;">
                ...
                <h4 style="margin-bottom: 20px; font-size:17px;">
                    <span>ID Register :</span> <strong>{{ $hajj_manifest_customer->reference }}</strong></br></br>
                    <span>Category :</span> <strong>Details Customer Manifest Hajj</strong>
                </h4>
            </div>
            <div class="card">
                <div class="card-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        {{ $hajj_manifest_customer->customer_name }}
                                    </td>
                                    <td class="align-middle">
                                        {{ $hajj_manifest_customer->customer_phone }}
                                    </td>
                            </tr>
                            </tbody>
                            ...
                            <tbody>
                                <tr>
                                    <td class="align-middle">
                                        {{ $hajj_manifest_customer->hajjPackages->package_code }}
                                    </td>
                                    <td class="align-middle">
                                        {{ $hajj_manifest_customer->hajjPackages->package_name }}
                                    </td>
                                    <td class="align-middle">
                                        {{ date('d-m-Y', strtotime($hajj_manifest_customer->hajjPackages->package_date)) }}
                                    </td>
                                    <td class="align-middle">
                                        {{ $hajj_manifest_customer->hajjPackages->package_departure }}
                                    </td>
                                    <td class="align-middle">
                                        {{ $hajj_manifest_customer->hajjPackages->package_days }} Days
                                    </td>
                                    <td class="align-middle">
                                        {{ $hajj_manifest_customer->room_group }}
                                    </td>
                                    <td class="align-middle">
