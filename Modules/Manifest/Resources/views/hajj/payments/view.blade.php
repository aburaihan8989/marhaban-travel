...
@if ($hajjManifestPayment->trx_type == 'Payment')
    ...
    @section('breadcrumb')
        <ol class="breadcrumb border-0 m-0">
            ...
            <li class="breadcrumb-item active">Details Customer Hajj Payment Receipt</li>
        </ol>
    @endsection
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex flex-wrap align-items-center">
                            <div>
                                ID Transaction : <strong>{{ $hajjManifestPayment->reference }}</strong>
                            </div>
                        ...
                        <div class="card-header d-flex flex-wrap align-items-center">
                            <div>
                                Category : <strong>Customer Hajj Payment Receipt</strong>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row mb-5">
                                ...
                                <table class="table table-striped col-lg-7">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="align-middle" style="font-size: 16px; font-weight: bold;">
                                                {{ $hajjManifestPayment->payment_reference }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
@else
    ...
    @section('breadcrumb')
        <ol class="breadcrumb border-0 m-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('hajj-manage-manifests.manage', $hajj_manifest->manifest_id) }}">Manage Hajj Manifest</a></li>
            <li class="breadcrumb-item"><a href="{{ route('hajj-manifest-payments.index', $hajjManifestPayment->hajj_manifest_customer_id) }}">{{ $hajj_manifest->reference }}</a></li>
            <li class="breadcrumb-item active">Details Customer Hajj Refund Receipt</li>
        </ol>
    @endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex flex-wrap align-items-center">
                            <div>
                                Category : <strong>Customer Hajj Refund Receipt</strong>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row mb-5">
