...
@section('title', 'Create Customer Payment Hajj')
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">Create Customer Payment Hajj</li>
    </ol>
@endsection
{{-- @dd($hajj_manifest); --}}
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="reference" required readonly value="INV/CR/{{ $hajj_manifest->reference }}">
                                    </div>
                                </div>
                            </div>
