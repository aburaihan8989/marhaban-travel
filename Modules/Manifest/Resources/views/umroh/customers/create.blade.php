...
@section('title', 'Add Customer Manifest Umroh')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('umroh-manage-manifests.manage', $umroh_manifest->id) }}">Manage Umroh Manifest</a></li>
        <li class="breadcrumb-item active">Add Customer Manifest Umroh</li>
    </ol>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <form id="umroh-manifest-customer-form" action="{{ route('umroh-manifest-customers.store', $umroh_manifest) }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="promo2" name="promo2" value="1">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="card">
                                        <div class="card-body">
                                            <i>
                                                <u><strong>Package Variant*1 </strong><strong class="text-primary"><i>({{ $umroh_manifest->umrohPackages->category }})</i></strong></u>
                                                <br>
                                                <br>
                                ...
                                <div class="col-lg-4">
                                    <div class="card">
                                        <div class="card-body">
                                            <i>
                                                <u><strong>Package Variant*2 </strong><strong class="text-primary"><i>({{ $umroh_manifest->umrohPackages->category_2 }})</i></strong></u>
                                                <br>
                                                <br>
