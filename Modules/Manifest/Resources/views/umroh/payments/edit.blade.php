...
@if ($umrohManifestPayment->trx_type == 'Payment')
    @section('title', 'Edit Customer Payment Umroh')
    ...
    @section('breadcrumb')
        <ol class="breadcrumb border-0 m-0">
            ...
            <li class="breadcrumb-item active">Edit Customer Payment Umroh</li>
        </ol>
    @endsection
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            <button class="btn btn-primary">Update Umroh Payment <i class="bi bi-check"></i></button>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="card">
    ...
    @endpush
@else
    @section('title', 'Edit Customer Refund Payment Umroh')
    ...
    @section('breadcrumb')
        <ol class="breadcrumb border-0 m-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('umroh-manage-manifests.manage', $umroh_manifest->manifest_id) }}">Manage Umroh Manifest</a></li>
            <li class="breadcrumb-item"><a href="{{ route('umroh-manifest-payments.index', $umrohManifestPayment->umroh_manifest_customer_id) }}">{{ $umroh_manifest->reference }}</a></li>
            <li class="breadcrumb-item active">Edit Customer Refund Payment Umroh</li>
        </ol>
    @endsection
                                ...
                                <div class="form-row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input id="refund_amount" type="text" class="form-control" name="refund_amount" required value="{{ old('refund_amount') ?? $umrohManifestPayment->refund_amount }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
