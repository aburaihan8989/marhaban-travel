...
@section('content')
    <div class="container-fluid mb-4">
        <form id="airline-form" action="{{ route('airlines.update', $airline->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">Update Airline <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="airline_name" required value="{{ $airline->airline_name }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="flight_route" id="flight_route" required>
                                            ...
                                            <option {{ $airline->flight_route == 'Direct' ? 'selected' : '' }} value="Direct">Direct</option>
                                            <option {{ $airline->flight_route == 'Transit' ? 'selected' : '' }} value="Transit">Transit</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="flight_duration" type="text" class="form-control" name="flight_duration" required value="{{ $airline->flight_duration }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="ticket_price">Ticket Price <span class="text-danger">*</span></label>
                                        <input id="ticket_price" type="text" class="form-control" name="ticket_price" required value="{{ format_currency($airline->ticket_price) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
