                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="package_capacity" type="text" class="form-control" name="package_capacity" required value="{{ $hajj_package->package_capacity }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="hotel_makkah" type="text" class="form-control" name="hotel_makkah" required value="{{ $hajj_package->hotel_makkah }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="hotel_madinah">Hotel Madinah <span class="text-danger">*</span></label>
                                        <input id="hotel_madinah" type="text" class="form-control" name="hotel_madinah" required value="{{ $hajj_package->hotel_madinah }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="package_cost" type="text" class="form-control" name="package_cost" required value="{{ format_currency($hajj_package->package_cost) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
