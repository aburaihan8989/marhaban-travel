...
@section('content')
    <div class="container-fluid">
        <form id="hotel-form" action="{{ route('hotels.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    @include('utils.alerts')
                    <div class="form-group">
                        <button class="btn btn-primary">Create Hotel <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="hotel_name" required value="{{ old('hotel_name') }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="hotel_price" type="text" class="form-control" name="hotel_price" required value="{{ old('hotel_price') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('page_scripts')
    <script>
        ...
        Dropzone.options.documentDropzone = {
            ...
            init: function () {
                @if(isset($hotel) && $airline->getMedia('hotels'))
